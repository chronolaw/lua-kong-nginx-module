...
int ngx_stream_lua_ffi_shdict_get_m1(const ngx_shdict_get_t *s);
...
int ngx_stream_lua_ffi_shdict_store_m1(const ngx_shdict_store_t *s);
...
int ngx_stream_lua_ffi_shdict_incr_m1(const ngx_shdict_incr_t *s);
