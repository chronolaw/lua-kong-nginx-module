...
int
ngx_http_lua_ffi_shdict_get_m1(const ngx_shdict_get_t *s)
{
...
int
ngx_http_lua_ffi_shdict_store_m1(const ngx_shdict_store_t *s)
{
...
int
ngx_http_lua_ffi_shdict_incr_m1(const ngx_shdict_incr_t *s)
{
...
int
ngx_http_lua_ffi_set_resp_header_m1(const ngx_set_resp_header_t *s)
{
